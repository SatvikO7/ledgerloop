...
| T3 rejected as inexact | 0 | the name and date agreed but the credit did not equal the settlement's net to the paise; with no reference, the amount is the identity claim and an approximate one is not a match |
